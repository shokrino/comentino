...
/*
چیزایی که میخوایم:
چک باکس جایگزینی کامنتیونو بجای کامنت پیشفرض

چک باکس جایگیزینی ایمیل با شماره موبایل کاربر

چک باکس تبدیل ستاره به ایموجی نظر دهی ووکامرس

یه باکس جهت نمایش شورت کد های کامنت بلاگ و ووکامرس
*/
